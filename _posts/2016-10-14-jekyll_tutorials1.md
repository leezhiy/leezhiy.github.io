...
　 经过各种找资料，踩过各种坑，终于使用 jekyll 搭建个人博客初步完成了，域名目前用得时 github 的。 接下来我会讲如何使用 Jekyll 搭建博客，[博客模板效果](http://leezhiy.github.io/#blog)。
...
　我这里讲的是部署到 Github Page 创建一个 github 账号，然后创建一个跟你账户名一样的仓库，如我的 github 账户名叫 [leezhiy](https://github.com/leezhiy)，我的 github 仓库名就叫 [leezhiy.github.io](https://github.com/leezhiy/leezhiy.github.io)，创建好了之后，把刚才建立的 myBlog 项目 push 到 username.github.io仓库里去（username指的是你的github用户名），检查你远端仓库已经跟你本地 myBlog 同步了，然后你在浏览器里输入 username.github.io ，就可以访问你的博客了。
...
在浏览器输入 [127.0.0.1:4000](127.0.0.1:4000) ， 就可以看到[leezhiy.github.io](http://leezhiy.github.io)博客效果了。
